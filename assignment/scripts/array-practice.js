...
let favoriteFoods = ['biryani','pakoda','Naan'];
console.log('My favoraite foods are',favoriteFoods);
...
console.log('The vaue of the 2nd item from animalArray is',secondAnimal);
...
console.log('The values in animarArray are',animalArray);
console.log('The last animal is animalArray is',lastAnimal);
...
console.log('Removed th first color',firstColor);
console.log('The colors are now',colors);
